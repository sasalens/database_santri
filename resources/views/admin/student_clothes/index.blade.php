@extends('layouts.app', ['title' => 'Data Pakaian Santri - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center">
            <button class="text-white bg-gray-600 px-4 py-2 shadow-sm rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                <a href="{{ route('admin.student_clothes.create') }}" class="flex items-center">
            ...
            <div class="relative mx-4">
                ...
                <form action="{{ route('admin.student_clothes.index') }}" method="GET">
                            ...
                            <tr class="border bg-white">
                                ...
                                <td class="px-10 py-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        <!-- Tautan untuk Edit -->
                                        <a href="{{ route('admin.student_clothes.edit', $cloth->id) }}" 
