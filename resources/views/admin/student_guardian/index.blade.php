@extends('layouts.app', ['title' => 'Data Wali Santri - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center">
            <button class="text-white bg-gray-600 px-4 py-2 shadow-sm rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                <a href="{{ route('admin.student_guardian.create') }}" class="flex items-center">
            ...
            <div class="relative mx-4">
                ...
                <form action="{{ route('admin.student_guardian.index') }}" method="GET">
