...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        @if (session('status'))
        <div class="bg-green-600 text-white px-5 py-3 rounded-md shadow-sm mt-3">
                    ...
                    <div class="p-6 bg-white rounded-md shadow-md">
                        ...
                        <div class="mt-4">
                            ...
                            <form method="POST" action="{{ url('user/two-factor-authentication') }}">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 bg-gray-600 text-sm text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                                    Enable Two-Factor
                                </button>
                            </form>
                            @else
                            ...
                            <form method="POST" action="{{ url('user/two-factor-authentication') }}">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 bg-red-600 text-sm text-gray-200 rounded-md hover:bg-red-900 focus:outline-none focus:bg-gray-700">
                                    Disable Two-Factor
                                </button>
                            </form>
                            ...
                            <form method="POST" action="{{ url('user/two-factor-recovery-codes') }}">
                                ...
                                <button type="submit"
                                    class="mt-4 px-4 py-2 bg-gray-600 text-sm text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                ...
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <form class="mt-4" action="{{ route('user-profile-information.update') }}" method="POST">
                        ...
                        <div class="flex justify-start mt-4">
                            <button type="submit"
                                class="px-4 py-2 my-4 bg-gray-600 text-gray-200 rounded-md text-sm hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Update Profile</button>
                        </div>
                    </form>
                </div>
                    ...
                    <form class="mt-4" action="{{ route('user-password.update') }}" method="POST">
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input type="password" name="current_password"
                                    class="form-input mt-1 block w-full rounded-md placeholder:italic" 
                        ...
                        <div class="mt-4">
                            <label class="block">
                                ...
                                <input type="password" name="password" class="form-input mt-1 block w-full rounded-md placeholder:italic"
                        ...
                        <div class="flex justify-start mt-4">
                            <button type="submit"
                                class="px-4 py-2 my-4 text-sm bg-gray-600 text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Update Password</button>
                        </div>
                    </form>
                </div>
            </div>
